...
def run_training():
    ...
    poems_vector, word_to_int, vocabularies = process_poems1('d:/大学/大三下/深度学习/exercise/chap6_RNN/tangshi_for_pytorch/poems.txt')
    # 生成batch
...
def gen_poem(begin_word):
    ...
    poems_vector, word_int_map, vocabularies = process_poems1('d:/大学/大三下/深度学习/exercise/chap6_RNN/tangshi_for_pytorch//poems.txt')
